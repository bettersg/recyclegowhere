...
const Footer = () => {
    ...
    return (
        <Box overflow="hidden" w="100vw" h="100%" p={2}>
            ...
            <Flex flexDir={{ base: "column", lg: "row", md: "row", sm: "column" }} justifyContent={{ md: "space-around", sm: "center" }} alignItems={{ base: "center" }} marginBottom={10}>
                <Flex flexDir="column" alignItems={{ base: "center", md: "start" }} >
                    <Heading as="h3" paddingBottom={1} fontSize="2xl">RecycleGoWhere</Heading>
                    <Link href="/" passHref>
                ...
                <Flex flexDir="column" alignItems={{ base: "center", md: "start" }}>
                    <Heading as="h3" paddingBottom={1} fontSize="2xl">Contact Us</Heading>
            ...
            <Flex flexDirection="column" justifyContent="space-between" alignItems="center" paddingTop={1}>
                <Text textAlign="center">A non-profit volunteer-run project by better.sg. </Text>
